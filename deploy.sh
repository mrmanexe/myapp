...
flutter build web --release --base-href="/mrmanexe.github.io/SecureSlumber/" #change '/myappRepo/' to the name of the github repo of your project
...
echo "Deployment complete! Visit: https://mrmanexe.github.io/SecureSlumber/" #change to your username in the link